...
class ContactAdmin extends Admin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper->with("Création d'un contact", array('description' => "Ce formulaire permet la création d'un contact.")) ;
        $formMapper->add('nom', 'text', array('help'=>"Nom du contact.")) ;
        $formMapper->add('date', 'date', array('help'=>"Date du message.")) ;
        $formMapper->add('email', 'email', array('help'=>"Email du contact.")) ;
        $formMapper->add('message', 'textarea', array('help'=>"Message du contact.")) ;
    }
