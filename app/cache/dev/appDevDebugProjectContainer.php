...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'admin.langage' => 'getAdmin_LangageService',
            'admin.membre' => 'getAdmin_MembreService',
            'admin.projet' => 'getAdmin_ProjetService',
            'admin.promotion' => 'getAdmin_PromotionService',
            'admin.tuto' => 'getAdmin_TutoService',
            'admin.type' => 'getAdmin_TypeService',
    ...
    /**
     * Gets the 'admin.contact' service.
     *
     * @return \AppBundle\Admin\ContactAdmin A AppBundle\Admin\ContactAdmin instance.
     */
    protected function getAdmin_ContactService()
    {
        $instance = new \AppBundle\Admin\ContactAdmin('admin.contact', 'AppBundle\\Entity\\Contact', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'admin.langage' service.
     *
     * @return \AppBundle\Admin\LangageAdmin A AppBundle\Admin\LangageAdmin instance.
     */
    protected function getAdmin_LangageService()
    {
        $instance = new \AppBundle\Admin\LangageAdmin('admin.langage', 'AppBundle\\Entity\\Langage', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'admin.membre' service.
     *
     * @return \AppBundle\Admin\MembreAdmin A AppBundle\Admin\MembreAdmin instance.
     */
    protected function getAdmin_MembreService()
    {
        $instance = new \AppBundle\Admin\MembreAdmin('admin.membre', 'AppBundle\\Entity\\Membre', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'admin.projet' service.
     *
     * @return \AppBundle\Admin\ProjetAdmin A AppBundle\Admin\ProjetAdmin instance.
     */
    protected function getAdmin_ProjetService()
    {
        $instance = new \AppBundle\Admin\ProjetAdmin('admin.projet', 'AppBundle\\Entity\\Projet', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'admin.promotion' service.
     *
     * @return \AppBundle\Admin\PromotionAdmin A AppBundle\Admin\PromotionAdmin instance.
     */
    protected function getAdmin_PromotionService()
    {
        $instance = new \AppBundle\Admin\PromotionAdmin('admin.promotion', 'AppBundle\\Entity\\Promotion', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'admin.tuto' service.
     *
     * @return \AppBundle\Admin\TutoAdmin A AppBundle\Admin\TutoAdmin instance.
     */
    protected function getAdmin_TutoService()
    {
        $instance = new \AppBundle\Admin\TutoAdmin('admin.tuto', 'AppBundle\\Entity\\Tuto', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'admin.type' service.
     *
     * @return \AppBundle\Admin\TypeAdmin A AppBundle\Admin\TypeAdmin instance.
     */
    protected function getAdmin_TypeService()
    {
        $instance = new \AppBundle\Admin\TypeAdmin('admin.type', 'AppBundle\\Entity\\Type', 'SonataAdminBundle:CRUD');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'digitaldesign_site', 'user' => 'root', 'password' => 'leconquetDU29217', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'ApplicationSonataUserBundle' => 'Application\\Sonata\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'SonataUserBundle' => 'Sonata\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8b9b8c0434b46d55765164e53b0df5e1741e41390e448c58a3ff56a059cf7fcf');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'admin.langage', 1 => 'admin.projet', 2 => 'admin.tuto', 3 => 'admin.type', 4 => 'admin.membre', 5 => 'admin.promotion', 6 => 'admin.contact', 7 => 'sonata.user.admin.user', 8 => 'sonata.user.admin.group'));
        $instance->setAdminGroups(array('Projets' => array('label' => 'Projets', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-keyboard-o"></i>', 'roles' => array(), 'items' => array(0 => 'admin.langage', 1 => 'admin.projet', 2 => 'admin.tuto', 3 => 'admin.type')), 'Ressources' => array('label' => 'Ressources', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-users"></i>', 'roles' => array(), 'items' => array(0 => 'admin.membre', 1 => 'admin.promotion')), 'Contact' => array('label' => 'Contact', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-envelope"></i>', 'roles' => array(), 'items' => array(0 => 'admin.contact')), 'sonata_user' => array('label' => 'sonata_user', 'label_catalogue' => 'SonataUserBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group'))));
        $instance->setAdminClasses(array('AppBundle\\Entity\\Langage' => array(0 => 'admin.langage'), 'AppBundle\\Entity\\Projet' => array(0 => 'admin.projet'), 'AppBundle\\Entity\\Tuto' => array(0 => 'admin.tuto'), 'AppBundle\\Entity\\Type' => array(0 => 'admin.type'), 'AppBundle\\Entity\\Membre' => array(0 => 'admin.membre'), 'AppBundle\\Entity\\Promotion' => array(0 => 'admin.promotion'), 'AppBundle\\Entity\\Contact' => array(0 => 'admin.contact'), 'Application\\Sonata\\UserBundle\\Entity\\User' => array(0 => 'sonata.user.admin.user'), 'Application\\Sonata\\UserBundle\\Entity\\Group' => array(0 => 'sonata.user.admin.group')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'admin.langage', 1 => 'admin.projet', 2 => 'admin.tuto', 3 => 'admin.type', 4 => 'admin.membre', 5 => 'admin.promotion', 6 => 'admin.contact', 7 => 'sonata.user.admin.user', 8 => 'sonata.user.admin.group'), $this);
    }
    ...
    {
        return $this->services['sonata.block.loader.service'] = new \Sonata\BlockBundle\Block\Loader\ServiceLoader(array(0 => 'sonata.user.block.menu', 1 => 'sonata.user.block.account', 2 => 'sonata.admin.block.admin_list', 3 => 'sonata.admin.block.search_result', 4 => 'sonata.block.service.text'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'date' => array('timezone' => 'Europe/Paris', 'format' => 'F j, Y H:i', 'interval_format' => '%d days'), 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'AsseticBundle', 8 => 'AppBundle', 9 => 'ApplicationSonataUserBundle', 10 => 'SonataCoreBundle', 11 => 'SonataBlockBundle', 12 => 'KnpMenuBundle', 13 => 'SonataDoctrineORMAdminBundle', 14 => 'SonataAdminBundle', 15 => 'SonataEasyExtendsBundle', 16 => 'FOSUserBundle', 17 => 'SonataUserBundle', 18 => 'DebugBundle', 19 => 'WebProfilerBundle', 20 => 'SensioDistributionBundle', 21 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        ...
        call_user_func(array(new \Symfony\Bundle\TwigBundle\DependencyInjection\Configurator\EnvironmentConfigurator('F j, Y H:i', '%d days', 'Europe/Paris', 0, '.', ','), 'configure'), $instance);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'admin', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5ab7ba270850a3.01973015'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5ab7ba270850a3.01973015')), true);
    ...
    protected function getSonata_Block_ManagerService()
    {
        ...
        $instance->add('sonata.admin.block.admin_list', 'sonata.admin.block.admin_list', array(0 => 'cms'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'digitaldesign_site',
            'database_user' => 'root',
            ...
            'assetic.bundles' => array(
                ...
                7 => 'AsseticBundle',
                8 => 'AppBundle',
                9 => 'ApplicationSonataUserBundle',
                10 => 'SonataCoreBundle',
                11 => 'SonataBlockBundle',
                12 => 'KnpMenuBundle',
            ...
            'sonata.admin.configuration.dashboard_blocks' => array(
                0 => array(
                    ...
                    'settings' => array(
                        'content' => '<h2>Interface d\'administration du Site Digital Design</h2>',
                    ),
                    'class' => 'col-md-4',
                ),
                1 => array(
